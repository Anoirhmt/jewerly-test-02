    ...
    <html lang="en">
      <body className={`${inter.variable} ${playfair.variable} font-sans flex flex-col min-h-screen scroll-smooth antialiased`}>
        <CartProvider>
          ...
          >
            <div className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 ease-out">
              <svg
                viewBox="0 0 24 24"
                fill="white"
                className="w-8 h-8"
