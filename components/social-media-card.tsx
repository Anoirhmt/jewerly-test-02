  ...
  return (
    <div className={`flex items-center justify-center gap-6 ${className}`}>
      ...
      <a 
        ...
        className="group relative flex items-center justify-center h-12 w-12 rounded-full bg-white shadow-sm hover:shadow-md transition-all duration-300 border border-black/[0.03]"
      >
        <svg 
